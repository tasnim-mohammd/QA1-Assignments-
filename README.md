...
### 13.Rename this method name (BuildMenu) to match regular expression " [a-z][a-zA-Z0-9]*$ ".
#### Issue Type : code smell
#### Issue Severity : Minor
...
### 14. Use static access with "javax.swing.WindowConstants" for "EXIT_ON_CLOSE".
#### Issue Type : Code Smell 
#### Issue Severity : Critical 
...
### 16. (5, 13) This class has 6 parents which is greater than 5 authorized. few seconds ago
#### - Issue Type: Code Smell, Issue Severity: MAJOR.
...
### 16.1 (6, 16) Make this "errorCode" field final.
...
For this problem:
### 16.2 (3, 13) This row has 7 parents, and this number is greater than the 5 validated parents.
#### - Issue Type: Code Smell, Issue Severity: MAJOR.
...
### 16.3 (5, 13) This class has 6 parents which is greater than 5 authorized.
...
### 17.1 This blocked of commented-out lines of code should be removed (closeDialog();).
### 17.2 This blocked of commented-out lines of code should be removed (System.out.println(e.getKeyCode());).
#### Issue Type : Code Smell 
#### Issue Severity : Major
...
### 18.1 Add a nested comment explaining why this method is empty, throw an UnsupportedOperationException or complete the implementation(keyTyped).
### 18.2 Add a nested comment explaining why this method is empty, throw an UnsupportedOperationException or complete the implementation(keyReleased).
#### Issue Type : Code Smell 
#### Issue Severity : Critical
...
### 19 (14,8) "parent" is the name of a field in "Component"**
#### Issue Type : Code Smell
#### Issue Severity : Blocker
...
### 20. (21, 9) Make "matcher" transient or serializable.
#### Issue Type : Code Smell
#### Issue Severity : Critical
